    ...
    descriptive: {
        ...
        content: `
            ...
            <ul class="list-disc pl-5 mb-4 space-y-1">
                <li><strong>Mean:</strong> Average value - useful for normally distributed data like age</li>
                <li><strong>Median:</strong> Middle value - better for skewed data like income or DMFT</li>
                <li><strong>Mode:</strong> Most frequent value - useful for categorical data</li>
                <li><strong>Standard Deviation:</strong> Spread of data around mean</li>
                <li><strong>Interquartile Range (IQR):</strong> Range of middle 50%, robust to outliers</li>
            </ul>
            <h4 class="font-semibold mb-2">Dental Applications</h4>
            <p class="mb-2">In periodontal research, report median (IQR) for pocket depths as distributions are typically skewed. For randomized trials, report mean ± SD for baseline characteristics to show balance.</p>
            <div class="bg-blue-50 p-3 rounded-lg border-l-4 border-blue-400">
                <p class="text-sm"><strong>Tip:</strong> Always check normality (Shapiro-Wilk test) before choosing mean vs median.</p>
            </div>
        `
    },
    hypothesis: {
...
function resetLLN() {
    clearInterval(simState.probability.interval);
    simState.probability = { trials: 0, successes: 0, probability: 0.5, interval: null };
